  ...
  public static function config($config = null, $direct = true){
    ...
    self::$default_config["basic"]["output_callback"] = function($state, $extraInfo = array()){
          ...
          <div class=\"form-group\">
            ...
            <div class=\"cols-sm-10\">
              <div class=\"input-group\">
                ...
                <input type=\"text\" name=\"identification\" class=\"form-control inputField\" id=\"logSysIdentification\" placeholder=\"Enter your email.\" required autofocus>
              </div>
            </div>
          </div>
          <div class=\"form-group cols-lg-12\">
            <button type=\"submit\" name=\"logSysForgotPass\" class=\"btn btn-primary btn-lg btn-block login-button\">Reset</button>
          </div>
        </form>";
      ...
      if($state === "invalidToken")
        ...
        return "<h3>Success : Password Reset Successful</h3><p>You may now login with your new password.</p> <a href=\"../index.php\" class=\"btn btn-primary btn-lg btn-block login-button\">Login</a>";
        ...
        $newPass = "
          <form action='". self::curPageURL() ."' method='POST'>
            <p>The Token key was Authorized. Now, you can change your password</p>
            <div class=\"form-group\">
              ...
              <div class=\"cols-sm-10\">
                <div class=\"input-group\">
                  <span class=\"input-group-addon\"><i class=\"fa fa-envelope fa-lg\" aria-hidden=\"true\"></i></span>
                  <input type=\"password\" name=\"logSysForgotPassNewPassword\" class=\"form-control inputField\" id=\"password\" placeholder=\"Enter your new password.\" required autofocus>
                </div>
              </div>
            </div>
            <div class=\"form-group\">
              <input type='hidden' name='token' value='{$extraInfo["resetPassToken"]}' />
              <label for=\"newPassword\" class=\"cols-sm-2 control-label\">Retype New Password</label>
              <div class=\"cols-sm-10\">
                <div class=\"input-group\">
                  <span class=\"input-group-addon\"><i class=\"fa fa-envelope fa-lg\" aria-hidden=\"true\"></i></span>
                  <input type=\"password\" name=\"logSysForgotPassRetypedPassword\" class=\"form-control inputField\" id=\"newPassword\" placeholder=\"Retype new password.\" required autofocus>
                </div>
              </div>
            </div>
            <div class=\"form-group cols-lg-12\">
              <button type=\"submit\" name=\"logSysForgotPassChange\" class=\"btn btn-primary btn-lg btn-block login-button\">Reset</button>
            </div>
          </form>";
    ...
    if( !isset($_POST['logSysForgotPass']) && !isset($_GET['resetPassToken']) && !isset($_POST['logSysForgotPassChange']) ){
      ...
      if($identification == ""){
        ...
        if(empty($cols)){
          ...
          $body   = "You have requester a password reset on ". self::$config['basic']['company'] .". Please click the following link :
          <blockquote>
          ...
          print("
                <p>An email has been sent to your email inbox with instructions. Check Your Mail Inbox and SPAM Folders.</p>

                <p>You may close this window.</p>
                <a href=\"../index.php\" class=\"btn btn-primary btn-lg btn-block login-button\">Exit</a>
              ");
